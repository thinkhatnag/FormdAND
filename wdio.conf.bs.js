...
export const config = {
    ...
    cuser: process.env.browserStack_Username,
  ...
  "appium:app": "bs://b4598fac3092d49da4c9f5fe00d93cda0c81be5d",
  "appium:noReset": true,
  ...
  "appium:appPackage": "com.thinkhat.formD",
  ...
  "appium:uiautomator2ServerInstallTimeout": 60000
    ...
    //         console.log('time taken by the test is :', duration, result, retries);
    //     }
    // },
    ...
    onComplete: function(_exitCode, _config, _capabilities, _results) {
        ...
        const generation = allure(['generate', 'allure-results', ]); // Use allure-commandline
